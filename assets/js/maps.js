...
const RECOMMENDED_LOCATIONS = [
  {
    ...
    placeDescription:
      "Salon de the Claude is a quaint & quirky spot located in central Antwerp, known primarily for its afternoon tea service. You can expect fresh scones with clotted cream & jam, delightful finger sandwiches and a variety of pastries on the menu, served of course with an extensive tea selection.",
  ...
  },
  {
    ...
    placeDescription:
      "Luddites is a bookstore, wine bar, and hideout from the modern world, all rolled into one. We welcome all people who love books and wine, but despise the technology-ridden society. So, absolutely no e-readers allowed inside. We sell English & Dutch books and serve great wine, coffee & chocolate cake.",
  ...
  },
  {
    ...
    placeDescription:
      "Bar Paniek is the ideal place for hot, summer days. Situated by the harbor, we offer you a relaxed atmosphere with great music & food. Come solo & enjoy a nice book under the sun, or meet up with friends. Everyone is welcome.",
  ...
  },
  {
    ...
    placeDescription:
      "Dogma is a 1920’s themed cocktail bar, which won’t disappoint. Run by a praised and passionate cocktail artist, you will find not only an exquisite range of exclusive cocktails, but also a cozy, candle-lit atmosphere with vintage charm which will make it an experience you won’t forget.",
  ...
  },
  {
    ...
    placeDescription:
      "Pazzo combines top affordable cuisine with an impressive combination of flavors. Music is present in all its dishes, just like in the wine pairings served with the food. You can expect a beautiful selection of fresh ravioli, risotto, truffle ice cream and much more here. Perfect for a romantic date. ",
  ...
  },
  {
    ...
    placeDescription:
      "At Eetkamer a L’infintiste not everyone can imagine a unique formula that hits the mark. Chef Marc Van Uffelen doesn't just send trendy dishes. He also involves his guests in the service. A unique experience so coveted that you often have to book months in advance to sit down here on weekends.",
  ...
  },
  {
    ...
    placeDescription:
      "After more than 18 months of testing different potato varieties & soil types, Frites Atelier landed on the perfect recipe. This restaurant serves one purpose - to serve you beautifully prepared fires with sensational toppings.  A must try for all. ",
  ...
  },
  {
    ...
    placeDescription:
      "Bubble Waffle brings a Hong Kong speciality to the streets of Antwerp. Here you can try bubble waffles with a Belgian twist, served with artisan ice creams, homemade sauces, fresh fruit and whipped cream. A guilty pleasure you can’t resist!",
  ...
  },
  {
    placeName: "Barchel",
    placeDescription:
      "Barchel , the place to be for good food and a feel-good mood. In the middle of the city in an authentic house with a cozy patio or on the sweltering Nieuw Zuid with a gigantic terrace in good weather. Enjoy our classics such as the Breakfast bagel & our famous pancakes or go for one of our weekly specials. ",
...
function addMarkerInfo(type = null) {
  const recommended_locations = type ? RECOMMENDED_LOCATIONS.filter((location) => location.type === type) : RECOMMENDED_LOCATIONS;
  markers = [];
  for (let i = 0; i < recommended_locations.length; i++) {
    //Location details displayed in infowindow
    var contentString =
      '<h5 id="firstHeading" class="firstHeading">' +
      recommended_locations[i].placeName +
      "</h5>" +
      '<div id="bodyContent">' +
      "<p>" +
      recommended_locations[i].placeImage +
      "</p>" +
      "<p>" +
      recommended_locations[i].placeDescription +
      "</p>" +
      "<p>" +
      recommended_locations[i].address +
      "</p>" +
      "<p>" +
      recommended_locations[i].openingTimes +
      "</p>" +
      "</div>";
